...
import { getParentSchedules } from "@/lib/api";
            ...
            {filtered.length === 0 ? (
              <View style={styles.emptyState}>
                ...
                <AppText style={styles.emptyDesc}>
                  Booked sessions for your students will appear here.
                </AppText>
              </View>
            ) : (
              filtered.map((schedule) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      router.push(
                        `/dashboard/parent-dashboard/schedule/${schedule.id}` as any,
                      )
                    }
                  >
                    {/* Header row */}
                    <View style={styles.cardHeader}>
                      <View style={styles.tutorRow}>
                        <Avatar
                          profileImgUrl={
                            schedule.tutor?.profileImgUrl ?? undefined
                          }
                          name={tutorName}
                          width={45}
                          height={45}
                        />
                        <View>
                          <AppText style={styles.tutorName}>{tutorName}</AppText>
                          {studentName ? (
                            <View style={styles.studentPill}>
                              <UserIcon size={10} color={colors.accent} />
                              <AppText style={styles.studentPillText}>
                                {studentName}
                              </AppText>
                            </View>
                          ) : null}
